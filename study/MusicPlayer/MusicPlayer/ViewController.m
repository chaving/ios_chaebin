...
- (void) thisAppStateGoToBackground:(NSNotificationCenter *)noti{
    ...
    if ([[self player] isPlaying]) {
        ...
        [self setShouldAppStatus:YES];
    }
    
    
}

- (void) thisAppStateGoToForground:(NSNotificationCenter *)noti{
    
    NSLog(@"Go to forground");
    
    if ([self shouldAppStatus]) {
