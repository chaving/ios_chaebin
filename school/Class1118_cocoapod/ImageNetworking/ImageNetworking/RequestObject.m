...
//                          [progressView setProgress:uploadProgress.fractionCompleted];
                          NSLog(@"uploding.. %lf %% completed", uploadProgress.fractionCompleted);
                      });
                  }
...
+ (void)requestDeleteImage:(NSString *)imageId {
    ...
    NSURL *requestURL = [self requestURL:RequestTypeDeleteImage param:paramDic];
    ...
    id deleteHandler = ^(NSURLResponse *response, id responseObject, NSError *error) {
